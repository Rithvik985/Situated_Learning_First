...
# === CONFIG ===
IMAGE_VLLM_MODEL = os.getenv("VLLM_MODEL_FOR_IMAGE")
IMAGE_VLLM_URL_NAME = os.getenv("VLLM_URL_FOR_IMAGE")
...
client = OpenAI(
    ...
    base_url=IMAGE_VLLM_URL_NAME #remove this line
)
...
def describe_educational_image_with_base64(base64_image):
    ...
    response = client.chat.completions.create(
        ...
        model=IMAGE_VLLM_MODEL,#remove this line
        messages=[
            {
                "role": "system",
                "content": (
